...
<?php if(session()->has('confirmacion_edit_prod')): ?>

    <script>Swal.fire('Buen Trabajo!','<?php echo e(session('confirmacion_edit_prod')); ?>','success')</script>
...
<?php echo $__env->make('layouts.plantilla_general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/BeastMex-S182/Proyecto_Beast/resources/views/producto/edit_prod.blade.php ENDPATH**/ ?>